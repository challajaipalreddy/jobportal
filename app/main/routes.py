...
PRESET_STUDY_MATERIALS = {
    'Python Notes & Coding': [
        {'id': 'preset-1', 'title': '140 + Basic Python Programs', 'file': 'python/140 + Basic Python Programs (1).pdf', 'icon': 'bi-filetype-py', 'desc': 'Complete beginner to advanced Python practice code collection.'},
        {'id': 'preset-2', 'title': 'Python Interview Codes & Solutions', 'file': 'python/python interview codes.pdf', 'icon': 'bi-code-square', 'desc': 'Handpicked Python interview coding questions with step-by-step logic.'},
        {'id': 'preset-3', 'title': 'Project Interview Guide', 'file': 'python/Project_Interview_Guide.pdf', 'icon': 'bi-journal-code', 'desc': 'How to explain Python projects in technical interviews.'},
        {'id': 'preset-4', 'title': 'Pandas Data Analysis Notes', 'file': 'pandas.pdf', 'icon': 'bi-table', 'desc': 'Comprehensive Pandas library cheat sheet & data manipulation notes.'}
    ],
    'Java & OOPs Notes': [
        {'id': 'preset-5', 'title': 'Java Core Complete Notes (Part 1)', 'file': 'java.pdf', 'icon': 'bi-filetype-java', 'desc': 'Fundamentals of Java programming & OOPs concepts.'},
        {'id': 'preset-6', 'title': 'Java Advanced Notes (Part 2)', 'file': 'java1.pdf', 'icon': 'bi-filetype-java', 'desc': 'Classes, Objects, Inheritance & Interfaces in Java.'},
        {'id': 'preset-7', 'title': 'Java Collections & Exception Notes', 'file': 'java2.pdf', 'icon': 'bi-filetype-java', 'desc': 'Lists, Sets, Maps, and Exception Handling.'},
        {'id': 'preset-8', 'title': 'Java Master Placement Guide', 'file': 'Jaava4.pdf', 'icon': 'bi-journal-bookmark', 'desc': 'Java interview questions and placement prep notes.'},
        {'id': 'preset-9', 'title': 'Java Conditional Statements Practice', 'file': 'Java_Conditional_Statements_Questions_Aligned.pdf', 'icon': 'bi-check-square', 'desc': 'If-else and switch-case practice problems.'},
        {'id': 'preset-10', 'title': 'Java I/O Questions & Solutions', 'file': 'Java_IO_Questions.pdf', 'icon': 'bi-hdd', 'desc': 'File reading, writing & Scanner class questions.'},
        {'id': 'preset-11', 'title': 'Java Looping Problems', 'file': 'Java_Looping_Problems.pdf', 'icon': 'bi-arrow-repeat', 'desc': 'For loops, while loops, and pattern printing questions.'},
        {'id': 'preset-12', 'title': 'Java Medium to Hard Problems', 'file': 'Java_Problems_Medium_Hard.pdf', 'icon': 'bi-exclamation-triangle', 'desc': 'Advanced logic & problem solving in Java.'},
        {'id': 'preset-13', 'title': 'Java String Problems', 'file': 'Java_String_Problems.pdf', 'icon': 'bi-type', 'desc': 'String manipulation, reversal, and substring questions.'}
    ],
    'SQL & Database Notes': [
        {'id': 'preset-14', 'title': 'Master SQL Complete Notes', 'file': 'sq/Master SQl.pdf', 'icon': 'bi-database-fill', 'desc': 'Complete SQL tutorial from basic SELECT to advanced JOINs.'},
        {'id': 'preset-15', 'title': 'SQL 100 Interview Questions', 'file': 'sq/SQL 100.pdf', 'icon': 'bi-database-check', 'desc': 'Top 100 SQL questions asked in technical rounds.'},
        {'id': 'preset-16', 'title': 'SQL 45 Important Questions', 'file': 'sq/SQL 45 questions.pdf', 'icon': 'bi-database-gear', 'desc': '45 high-frequency SQL problem sets with solutions.'},
        {'id': 'preset-17', 'title': 'SQL Questions by Google', 'file': 'sq/SQL questions by Google.pdf', 'icon': 'bi-google', 'desc': 'Real SQL interview problems asked in Google drives.'},
        {'id': 'preset-18', 'title': 'SQL Placement Questions', 'file': 'sq/SQL questions for placement .pdf', 'icon': 'bi-briefcase', 'desc': 'Campus placement specific SQL question bank.'},
        {'id': 'preset-19', 'title': 'SQL Joins Master Notes', 'file': 'sq/SQl Joins.pdf', 'icon': 'bi-diagram-3-fill', 'desc': 'Visual guide to INNER, LEFT, RIGHT & FULL OUTER JOINs.'},
        {'id': 'preset-20', 'title': 'SQL Window Functions Guide', 'file': 'sq/Window Function.pdf', 'icon': 'bi-window-stack', 'desc': 'ROW_NUMBER(), RANK(), DENSE_RANK(), and LEAD/LAG.'},
        {'id': 'preset-21', 'title': 'SQL Cheat Sheet', 'file': 'sq/sql Cheat Sheet.pdf', 'icon': 'bi-file-earmark-code', 'desc': 'Handy SQL syntax cheat sheet for quick revision.'},
        {'id': 'preset-22', 'title': 'SQL Business Analyst Notes', 'file': 'sq/sql business analsyt.pdf', 'icon': 'bi-graph-up', 'desc': 'Data analysis queries for Business Analyst roles.'},
        {'id': 'preset-23', 'title': 'SQL Definitions & Theory', 'file': 'sq/sql definitions.pdf', 'icon': 'bi-book-half', 'desc': 'DDL, DML, DCL, TCL, ACID properties & Normalization.'},
        {'id': 'preset-24', 'title': 'SQL Full Notes & Queries', 'file': 'sq/sql full notes.pdf', 'icon': 'bi-file-earmark-text', 'desc': 'Full handwritten SQL notes with query examples.'},
        {'id': 'preset-25', 'title': 'MongoDB Interview Questions', 'file': 'MongoDB_Interview_Questions.pdf', 'icon': 'bi-filetype-json', 'desc': 'NoSQL & MongoDB interview question bank.'}
    ],
    'Aptitude & Reasoning Notes': [
        {'id': 'preset-26', 'title': 'Aptitude Topics & Shortcuts', 'file': 'apptitude/Aptitude Topics.pdf', 'icon': 'bi-calculator', 'desc': 'Quantitative aptitude formulas & shortcut calculation tricks.'},
        {'id': 'preset-27', 'title': 'Complete Placement Aptitude Guide', 'file': 'apptitude/topics.pdf', 'icon': 'bi-puzzle', 'desc': 'Comprehensive aptitude, logical & verbal reasoning notes.'}
    ],
    'Company Specific Placement Notes': [
        {'id': 'preset-28', 'title': 'TCS NQT Complete Study Material', 'file': 'Tcs NQT.pdf', 'icon': 'bi-building-fill-check', 'desc': 'TCS NQT exam pattern, previous papers & sample questions.'},
        {'id': 'preset-29', 'title': 'Deloitte Placement Guide', 'file': 'Deloitee.pdf', 'icon': 'bi-building', 'desc': 'Deloitte Analyst interview questions & test syllabus.'},
        {'id': 'preset-30', 'title': 'Cognizant Data Analyst Material', 'file': 'Cognizant Data analyst.pdf', 'icon': 'bi-file-earmark-bar-graph', 'desc': 'Cognizant Data Analyst test pattern & preparation notes.'},
        {'id': 'preset-31', 'title': 'Cognizant 2025 Interview Questions', 'file': 'Cognizant_Interview_Questions_2025.pdf', 'icon': 'bi-question-circle', 'desc': 'Recent Cognizant interview questions.'},
        {'id': 'preset-32', 'title': 'Data Structures & Algorithms (DSA)', 'file': 'DSA.pdf', 'icon': 'bi-diagram-2', 'desc': 'Complete DSA notes covering Trees, Graphs & Dynamic Programming.'}
    ],
    'Data Science & Power BI Notes': [
        {'id': 'preset-33', 'title': 'Power BI Master Notes', 'file': 'Power bi.pdf', 'icon': 'bi-bar-chart-line-fill', 'desc': 'Complete Power BI visual dashboards & DAX formulas.'},
        {'id': 'preset-34', 'title': 'Power BI Interview QnA', 'file': 'Power_BI_interview_QnA[1].pdf', 'icon': 'bi-file-earmark-easel', 'desc': 'Top Power BI interview questions & answers.'},
        {'id': 'preset-35', 'title': 'Myntra Data Analyst Interview Questions', 'file': 'Myntra Data Analyst Interview.pdf', 'icon': 'bi-bag-check', 'desc': 'Real Myntra Data Analyst interview case studies.'},
        {'id': 'preset-36', 'title': 'Roadmap for Data Analyst Career', 'file': 'Roadmap for data analysis.pdf', 'icon': 'bi-signpost-split', 'desc': 'Step-by-step career path to become a Data Analyst.'},
        {'id': 'preset-37', 'title': 'AWS Cloud Practitioner Guide', 'file': 'aws.pdf', 'icon': 'bi-cloud-check', 'desc': 'AWS cloud services, S3, EC2 & certification basics.'}
    ]
}

def get_deleted_preset_ids():
    try:
...
def study_materials():
    ...
    # Build active preset categories
    for cat_name, notes in PRESET_STUDY_MATERIALS.items():
        ...
        if active_notes:
            categories[cat_name] = active_notes

    # Append custom uploaded DB materials
    try:
...
def ads_txt():
    content = "google.com, pub-1976255607418432, DIRECT, f08c47fec0942fa0\n"
    response = make_response(content)
